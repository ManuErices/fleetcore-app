      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card rounded-3xl shadow-2xl overflow-hidden border border-white/10 animate-fadeInUp">
          ...
          <div className="p-8 space-y-6">
            ...
            >
              <div className="relative flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-2xl shadow-lg hover:shadow-xl hover:border-blue-400 hover:bg-blue-50 transition-all">
                <svg className="w-6 h-6 transition-transform hover:scale-110" viewBox="0 0 24 24">
