      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card rounded-3xl shadow-2xl overflow-hidden border border-white/10 animate-fadeInUp">
          ...
          <div className="p-8 space-y-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl" />
              
              <div className="relative flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-2xl shadow-lg hover:shadow-xl transition-all group-hover:border-blue-600">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-500 font-medium">O usa</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full group relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-700 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl" />
              
              <div className="relative flex items-center justify-center gap-3 px-6 py-4 bg-white border-2 border-slate-200 rounded-2xl shadow-lg hover:shadow-xl transition-all group-hover:border-purple-600">
                <svg className="w-6 h-6 text-purple-600 group-hover:text-white group-hover:scale-110 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="px-8 pb-8 pt-4 border-t border-slate-100">
            <p className="text-center text-xs text-slate-500">
              © {new Date().getFullYear()} MPF Ingeniería Civil SpA
              <br />
